...
type SystemEvent struct {
	...
	Posistion        *string `json:"posistion"`
...
type AreaEvent struct {
	Alarmareastate   *uint32 `josn:"Alarmareastate"`
	Alarmoptions     *uint32 `josn:"alarmoptions"`
	Alarmstateparams *uint64 `josn:"alarmstateparams"`
	Armingerror      *uint32 `josn:"armingerror"`
	Depzonenr        *uint32 `josn:"depzonenr"`
	Zonenumber       *uint32 `josn:"zonenumber"`
}
